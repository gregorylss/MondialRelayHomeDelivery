...
class DeliveryPrice extends BaseLoop implements ArraySearchLoopInterface
{
    ...
    public function buildArray()
    {
        ...
        if (null !== $country = CountryQuery::create()->findPk($this->getCountryId())) {
            ...
            /** @var MondialRelayHomeDeliveryZoneConfigurationQuery $zone */
            foreach ($zones as $zone) {
                $result = [];

                if (null !== $deliveryPrice = MondialRelayHomeDeliveryPriceQuery::create()
                    ...
                    // Get insurance cost
                    if (null !== $insurance = MondialRelayHomeDeliveryInsuranceQuery::create()
    ...
    {
        /** @var MondialRelayHomeDeliveryPrice $item */
